...
public class NetworkConnection {
    ...
    private Class classType = BaseRequest.class;
    private Gson gson;
        ...
        CustomJsonObjectRequest cjor = new CustomJsonObjectRequest(method,uri,params,
                new Response.Listener<JSONObject>(){
                    ...
                    public void onResponse(JSONObject jsonObject) {
                        ...
                        BaseRequest ob = gson.fromJson(jsonObject.toString(),BaseRequest.class);
                        response.doAfter(ob);
                    }
    ...
    public void conectionVolleySimple(final ResponseConnection response,String uri,int method){
        ...
        CustomJsonObjectRequest cjor = new CustomJsonObjectRequest(method,uri,params,
                new Response.Listener<JSONObject>(){
                    ...
                    public void onResponse(JSONObject jsonObject) {
                        Log.i("StriptJson", "Sucess: " + jsonObject);
                        BaseRequest ob = new BaseRequest();
                        ob.setData(jsonObject);
                        response.doAfter(ob);
                    }
                },new Response.ErrorListener(){
