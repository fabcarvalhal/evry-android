...
import fabriciocarvalhal.com.br.evry.Eventos.EventosActivity;
...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    private void sendNotification(RemoteMessage notification) {
        ...
        if(notification.getData().containsKey("id")){
            intent.putExtra("event_id", Integer.parseInt(notification.getData().get("id")) );
